...
- Keep the interview a spoken back-and-forth with no artificial turn-taking friction: stopping a recording submits it, the mic reopens when the interviewer stops speaking, and silence ends the candidate's turn. Never require a separate submit press for a spoken answer.
